...
<script type="text/javascript" src="js/view_sub.js"></script>
</head>
<body>
...
<div id="cc">
  <p>&nbsp;</p>
  <p align="right" class="style16 style22"><span class="style17">Welcome <?php echo $_SESSION['sname'];?></span></p>
  </div>
 <div id="banner">
<table width="100%" border="0" align="center">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
           <td align="left"><p class="style18"><span class="style29">View Subjects</span></p>
             </td>
      </tr>
    </table></td>
  </tr>
